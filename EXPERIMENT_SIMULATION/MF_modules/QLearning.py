...
class QLearning:
	...
	def __init__(self, experiment, map_file, initial_variables, boundaries_exp, parameters, options_log):
		...
		"""
		# ---------------------------------------------------------------------------
		# /!\ Not used by this module, but used for consistency
		...
		for state in self.map["transitionActions"]:
			...
			# self.dict_decision["values"][s]={"history_decisions": [[0]*self.window_size,[0]*self.window_size,
			# 														[0]*self.window_size,[0]*self.window_size,
			# 														[0]*self.window_size,[0]*self.window_size,
			# 														[0]*self.window_size,[0]*self.window_size]}
			# -----------------------------------------------------------------------
		...
		if self.log == True:
			...
			print('beforerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr\n')
			self.actions_evolution_log.close()
			print('afterrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr\n')
			# -----------------------------------------------------------------------
