...
class QLearningReplayBudget:
	...
	def __init__(self, experiment, map_file, initial_variables, action_space, boundaries_exp, parameters, options_log):
		...
		self.base_it_replay = 100 # 100 # 10
	...
	def replayExperience(self):
		...
		while True:
			...
			new_qvalue, qvalue_previous_state = self.learn(replay_previous_state, replay_action, replay_current_state, replay_reward_obtained)
